...
<body class="bg-gray-50 dark:bg-gray-800">
                    ...
                    <div class="flex items-center ml-3">
                        <div class="flex items-center">
                            <div class="px-4 py-3" role="none">
                                ...
                                <p class="text-sm text-end font-medium text-gray-900 truncate dark:text-gray-300"
                                    role="none">
                                    akib.siddiki@gmail.com
                                </p>
                            </div>
                            <button type="button"
                                ...
                                <img class="w-8 h-8 rounded-full"
                                    src="https://hrm.emythmaker.com/media/profileImg/apu-1.jpg" alt="user photo">
                            </button>
                        </div>
    ...
    <div class="flex pt-16 overflow-hidden bg-gray-50 dark:bg-gray-900">
        ...
        <div id="main-content" class="relative w-full h-full overflow-y-auto bg-gray-50 lg:ml-64 dark:bg-gray-900">
            ...
            <p class="my-10 text-sm text-center text-gray-500"> © 2019-2024 <a href="https://github.com/AkibSiddiki"
